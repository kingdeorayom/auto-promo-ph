            ...
            <Layout>
                <Box className={styles.container}>
                    <Box className={styles.wrapper}>
                        <Typography fontSize='1.5rem' variant="h1" fontWeight='700' mb={2}>Privacy Policy for Auto Promo PH</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={2}>Consent</Typography>
                        <Typography mb={2}>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</Typography>

                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>Information we collect</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mt={3} mb={2}>How we use your information</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>Log Files</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>Cookies and Web Beacons</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>Advertising Partners Privacy Policies</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>Third Party Privacy Policies</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>GDPR Data Protection Rights</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>{"Children's"} Information</Typography>
                        ...
                        <Typography fontSize='1.5rem' variant="h2" fontWeight='700' mb={3} mt={2}>Changes to This Privacy Policy</Typography>
